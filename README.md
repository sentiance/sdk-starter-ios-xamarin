...
4. [Download the Sentiance iOS Xamarin SDK](https://sentiance-sdk.s3.amazonaws.com/ios/xamarin/sentiance-ios-sdk-5.1.2.zip) and extract
5. Place SENTSDK-5.1.2.dll and SENTSDK.bundle in the `Libs` folder.
